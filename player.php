...
<table cellspacing="1" width="90%" class="center">
    <tr>
        ...
        <th style="width:80px"> Player Number </th>
        <th> Team </th>
        <th> Event Name </th>
 <!--<th> Position </th> -->
        <th> Height </th>
    ...
    <?php
    include "connect.php";
    $records_playinfo = mysqli_query($conn,"select distinct pname, pnum,tname, ename, height from playinfo");
